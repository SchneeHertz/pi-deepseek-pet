"""Generate GIF previews from Pi DeepSeek Pet runtime WebM assets.

素材处理链的附属步骤：把 assets/animations/webm/ 的 640×360 透明 WebM
转成 assets/preview/ 下的 GIF，供 README 等 Markdown 页面展示。
...
- 故 README 预览区用 GIF 演示，完整透明视频保留在 assets/animations/webm/。
...
SRC = PROJECT_ROOT / "assets" / "animations" / "webm"
OUT = PROJECT_ROOT / "assets" / "preview"
